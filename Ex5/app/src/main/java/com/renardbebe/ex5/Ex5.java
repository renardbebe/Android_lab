...
public class Ex5 extends AppCompatActivity {
    ...
    private static final String STATICACTION_1 = "com.renardbebe.ex5.MyStaticFilter_1";
    ...
    mWidget myWidget = new mWidget();  // 定义桌面小部件

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(com.renardbebe.ex5.R.layout.activity_ex3);
        RegisterRec();
        ...
        /* 主页商品列表 */
        mRecyclerView = (RecyclerView) findViewById(com.renardbebe.ex5.R.id.shop);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mRecyclerView.setVisibility(View.VISIBLE);
        //mListView.setVisibility(View.INVISIBLE);
        homeAdapter = new HomeAdapter(list, Ex5.this);
        ...
        homeAdapter.setOnItemClickListener(new HomeAdapter.OnItemClickListener(){
                ...
                alertDialog.setTitle("请选择需要展示的内容：").setItems(items,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                if(i == 0) {
                                    Intent intent = new Intent(Ex5.this, detail.class);
                                    ...
                                    /*Intent intent = new Intent(Ex5.this, showPicture.class);
                                    intent.putExtra("Name", list.get(position).getName());
            ...
            public void onLongClick(int position) {
                Toast.makeText(Ex5.this,"移除第" + String.valueOf(position+1) + "个商品",Toast.LENGTH_SHORT).show();
        ...
        /* 购物车界面 */
        mListView = (ListView) findViewById(com.renardbebe.ex5.R.id.caritem);
        mListView.setVisibility(View.INVISIBLE);

        shopAdapter = new ShopAdapter(carlist, Ex5.this);
        ...
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long l) {
                if(carlist.get(position).getName() != "购物车") {
                    final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Ex5.this);
        ...
        /* 悬浮按键 */
        f = (ImageButton) findViewById(com.renardbebe.ex5.R.id.floating);
        f.setTag("0");
        f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (f.getTag() == "0") {
                    f.setTag("1");
                    f.setImageResource(com.renardbebe.ex5.R.mipmap.home);
                    mListView.setVisibility(View.VISIBLE);
                    mRecyclerView.setVisibility(View.INVISIBLE);
                } else {
                    f.setTag("0");
                    f.setImageResource(com.renardbebe.ex5.R.mipmap.car);
                    mListView.setVisibility(View.INVISIBLE);
                    mRecyclerView.setVisibility(View.VISIBLE);
                }
            }
    ...
    protected void onNewIntent(Intent intent) {
        if(intent.getAction().equals(DYNAMICACTION)) {  // 跳转到购物车
            mRecyclerView.setVisibility(View.INVISIBLE);
            mListView.setVisibility(View.VISIBLE);
            f.setImageResource(com.renardbebe.ex5.R.mipmap.home);
            f.setTag("1");
    ...
    void RegisterRec() {
        ...
        registerReceiver(myWidget, dynamicFilter);  // 桌面小部件注册动态广播
    }
